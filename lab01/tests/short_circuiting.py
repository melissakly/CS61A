      ...
      'cases': [
        {
          ...
          >>> not 0
          True
          >>> (1 + 1) and 1  # If this errors, just type Error.
          1
          >>> 1/0 or True  # If this errors, just type Error.
          Error
          >>> '' or None and 1/0  # If this errors, just type Error.
          Nothing
          >>> (True or False) and 0  # If this errors, just type Error.
          0
          >>> -12 and (1 - 1)  # If this errors, just type Error.
          0
          """,
          'hidden': False,
          'locked': False
